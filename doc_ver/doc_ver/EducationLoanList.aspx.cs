...
namespace doc_ver
{
    public partial class EducationLoanList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                String squery = "select ID, FULL_NAME, PAN_NO from EducationLoan" +
                ...
                String squery2 = "select ID, FULL_NAME, PAN_NO from EducationLoan" +
                ...
                String squery3 = "select ID, FULL_NAME, PAN_NO from EducationLoan" +
        ...
        protected void linkSelect_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EducationLoanPage.aspx?PanNum=" + firstColumn);
        ...
        protected void Pending_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EducationLoanPage.aspx?PanNum=" + name);
        }
